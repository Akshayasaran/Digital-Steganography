...
public class Encode extends javax.swing.JPanel {
    ...
    private void encodeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_encodeButtonActionPerformed
        ...
        if (secretKey == null || secretKey.isEmpty()) {
            secretKeyError.setText("Secret Key is required");
            validate = false;
        } else {
        ...
        } else if (steganoMethod.equals("DCT")) {
            if (fileExt.equals("jpg") || fileExt.equals("tif") || fileExt.equals("gif") || fileExt.equals("bmp")) {
                try {
                    FileWriter fileWriter = new FileWriter("input.txt");
                    fileWriter.write(encryptedMessage);
                    fileWriter.close();
                    String str = "-e input.txt " + imageFilePath + " " + filePath + "\\" + fileName + "_encoded" + "." + fileExt;
                    Embed.main(str.split(" "));
